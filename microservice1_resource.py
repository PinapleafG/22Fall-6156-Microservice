...
class MicroService1:
    ...
    def get_location_by_name(item_name):
        ...
        if item_id >= 60000000:
            ...
            stations =[{"station_id":item_id, "station_name":item_name}]
            return item_id, item_name, 4, stations, solar_system_name, constellation_name, region_name
...
#children station
            sql = """SELECT item_id as station_id, item_name as station_name  FROM microService_1.Map where solar_system_id= %s and item_id >= 60000000"""
            key = [item_id]
            conn = MicroService1._get_connection()
            cur = conn.cursor()
            res = cur.execute(sql, args=key)
            ...
            return item_id, item_name, 3, stations, 'None', constellation_name, region_name
...
# children station
            sql = """SELECT item_id as station_id, item_name as station_name  FROM microService_1.Map where constellation_id= %s and item_id >= 60000000"""
            key = [item_id]
            conn = MicroService1._get_connection()
            cur = conn.cursor()
            res = cur.execute(sql, args=key)
            ...
            return item_id, item_name, 2, stations, 'None', 'None', region_name
...
# children station
            sql = """SELECT item_id as station_id, item_name as station_name  FROM microService_1.Map where region_id= %s and item_id >= 60000000"""
            key = [item_id]
            conn = MicroService1._get_connection()
            cur = conn.cursor()
            res = cur.execute(sql, args=key)
            ...
            return item_id, item_name, 1, stations, 'None', 'None', 'None'
